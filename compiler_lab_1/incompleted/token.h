...
// Dinh nghia cac loai Token
typedef enum {
  TK_NONE, TK_IDENT, TK_NUMBER, TK_CHAR, TK_EOF,
  // Tu khoa (key word) nhu KW_PROGRAM
  ...
  // Ki hieu (symbol) nhu SB_SEMICOLON 
...
// Dinh nghia cau truc cua 1 token
typedef struct {
...
// cap phap bo nho va tao 1 token moi
